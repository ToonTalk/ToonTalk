...
//for making popup windows

function popup (url, h, w) {
	modifiers = 'directories=no,menubar=no,status=no,height='+h+',width='+w;
	pp = window.open(url, 'ppwin' , modifiers);
}
...
function sort(e) {
    ...
    for (var im = 0; (node = dad.getElementsByTagName("th").item(im)); im++) {
        ...
        if (node.lastChild.nodeName == 'IMG')
        {
            ...
            node.getElementsByTagName('img').item(lastindex).setAttribute('src','http://www.weblabs.org.uk/wlplone/arrowBlank.gif');
        }
    }
    ...
    for (var i = 0; (node = dad.getElementsByTagName("th").item(i)); i++) {
        ...
        if (!xre.exec(node.className) && node.childNodes.item(1).nodeValue == name) 
        {
            ...
            lastindex = node.getElementsByTagName('img').length -1;
            node.getElementsByTagName('img').item(lastindex).setAttribute('src','http://www.weblabs.org.uk/wlplone/arrowUp.gif');
            break;
        }
    }
    ...
    if (a.length > 1) {
	       ...
	       && a[1][0] == getConcatenedTextContent(tbody.getElementsByTagName("tr").item(1).getElementsByTagName("td").item(i))) 
        {
            ...
            el.getElementsByTagName('img').item(lastindex).setAttribute('src','http://www.weblabs.org.uk/wlplone/arrowDown.gif');
        }
    ...
    for (var t = 0; t < tbls.length; t++)
        ...
        if (re.exec(tbls[t].className) && !xre.exec(tbls[t].className))
        {
            try {
                ...
                blankarrow.setAttribute('src','http://www.weblabs.org.uk/wlplone/arrowBlank.gif');
                ...
                for (var i = 0; (node = thead.getElementsByTagName("th").item(i)); i++) {
                    ...
                    if (!xre.exec(node.className)) {
                        ...
                        if (!initialsort) {
                            ...
                            uparrow.setAttribute('src','http://www.weblabs.org.uk/wlplone/arrowUp.gif');
...
function toggleSelect(selectbutton) {
  if (isSelected == false) {
    selectbutton.setAttribute('src','http://www.weblabs.org.uk/wlplone/select_none_icon.gif');
    return selectAll();
  }
  else {
    selectbutton.setAttribute('src','http://www.weblabs.org.uk/wlplone/select_all_icon.gif');
    return deselectAll();
  }
}
