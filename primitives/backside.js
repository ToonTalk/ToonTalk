        ...
        create: function (widget) {
            ...
            var help_button_clicked = function (event) {
                                          if (relative_URL) {
                                              ...
                                              TT.UTILITIES.add_iframe_popup(help_URL);
                                              event.stopPropagation();
                                          } else {
                                              // need to work around:
            ...
            backside.widget_side_dropped_on_me =
                function (side_of_other, options) {
                    ...
                    if (this.visible() && (!options.robot || options.robot.visible())) {
                    ...
                    } else if (options.event && !side_of_other.is_backside() && this.get_frontside_element() && !side_of_other.is_sensor()) {
...
//                     }
            ...
            backside.add_backside_widget = function (widget_side, options) {
                return this.get_widget().add_backside_widget(widget_side, options);
            };
                                        ...
                                        if (!widget_side_element.parentElement) {
                                            ...
                                            try {
                                                 ...
                                                 TT.UTILITIES.report_internal_error("A backside is contained in one its backside widgets. This makes no sense. " +
                                                                                    ...
                                                                                    "This has been delayed so possibily things have changed since scheduled. " + e.message);
                                            }
                                            if (TT.logging && TT.logging.indexOf('backside-widgets') >= 0) {
...
//             };
            ...
            backside.update_display = function (caused_by_document_not_hidden) {
                ...
                if (caused_by_document_not_hidden) {
       ...
       hide_backside: function (event) {
            ...
            TT.UTILITIES.for_each_batch(widget.get_backside_widgets(),
